...
export const ui = {
  ...
  home: {
    ...
    stats: [
      {
        ...
        es: "Años de trayectoria profesional",
      },
      {
        value: "Banco Popular",
        en: "Current employer — largest bank in DR",
        es: "El banco más grande de la República Dominicana",
      },
      {
        value: "2M+",
        en: "Bank customers impacted",
        es: "Clientes que interactúan con sistemas que lidero",
      },
      {
        value: "Bilingüe",
        en: "English & Spanish",
        es: "Inglés nativo y español profesional",
      },
    ],
    ...
    brings: [
      {
        number: "01",
        title: {
          en: "Leadership under complexity",
          es: "Liderazgo donde otros ven caos",
        },
        body: {
      ...
      },
      {
        number: "02",
        title: {
          en: "Systems-level thinking",
          es: "Diseño que entiende el sistema completo",
        },
        body: {
      ...
      },
      {
        ...
        title: {
          ...
          es: "Habla el idioma del equipo de desarrollo",
        },
        body: {
    ...
    ctaHeading: {
      ...
      es: "¿Tienes un reto que resolver?",
    },
    ctaBody: {
  ...
  about: {
    ...
    glanceRows: [
      {
        label: { en: "Experience", es: "Trayectoria" },
        value: { en: "5+ years", es: "Más de 3 años" },
      },
      {
        label: { en: "Domain", es: "Industria" },
        value: { en: "Banking & Systems", es: "FinTech" },
      },
      {
        label: { en: "Current focus", es: "Transición hacia" },
        value: { en: "UX Designer", es: "Diseñador UX" },
      },
      {
        label: { en: "Location", es: "Ubicación" },
        value: { en: "Santo Domingo, DR", es: "Santo Domingo, RD" },
      },
      {
        label: { en: "Status", es: "Disponibilidad" },
        value: { en: "Open to roles", es: "Abierto a nuevas oportunidades" },
      },
    ],
    strengthsLabel: {
      en: "What I bring to a design team",
      es: "Lo que no encontrarás fácilmente en otro diseñador",
    },
    strengths: [
      {
        en: "Leading systems projects in regulated environments",
        es: "Experiencia liderando proyectos de tecnología en entornos regulados",
      },
      {
        en: "Translating technical constraints into design decisions",
        es: "Capacidad de convertir restricciones técnicas en decisiones de diseño acertadas",
      },
      {
        en: "Bridging engineering, product, and business",
        es: "Puente natural entre equipos de ingeniería, producto y negocio",
      },
      {
        en: "Conducting user research and journey mapping",
        es: "Investigación de usuarios y mapeo de experiencia aplicados a contextos complejos",
      },
      {
        en: "Bilingual delivery — English and Spanish",
        es: "Comunicación profesional en inglés y español",
      },
    ],
    ...
    story: [
      {
        ...
        es: "Ingeniero en Sistemas egresado de la Pontificia Universidad Católica Madre y Maestra (PUCMM) en 2023, con experiencia en soporte técnico, análisis de datos y gestión de operaciones, actualmente desempeñándome como Líder de Proyectos en Desarrollo de Sistemas en Banco Popular Dominicano.",
      },
      {
        ...
        es: "Mi interés por el diseño de experiencias de usuario surge de una fuerte atención al detalle y una curiosidad constante por comprender cómo las personas interactúan con los productos digitales. Considero que el valor de una solución tecnológica no solo radica en su desarrollo técnico, sino en cómo es percibida, entendida y utilizada por sus usuarios.",
      },
      {
        ...
        es: "En 2024 inicié mi formación formal en el área de UX/UI, complementando mi experiencia profesional con estudios especializados y el desarrollo de proyectos prácticos. Este portafolio representa mi proceso de transición hacia el diseño, así como mi compromiso con la creación de soluciones digitales intuitivas, accesibles y centradas en el usuario.",
      },
    ],
    ...
    skillGroups: [
      ...
      {
        category: { en: "Delivery", es: "Gestión" },
        items: [
          "Agile / Scrum",
          "Waterfall",
          "Project Leadership",
  ...
  contact: {
    ...
    formMsgPh: {
      ...
      es: "Cuéntame sobre tu proyecto u oportunidad...",
    },
    formSend: { en: "Send message", es: "Enviar mensaje" },
    formNote: {
      en: "Typically responds within 48 hours",
      es: "Respondo en menos de 48 horas",
    },
    sentTitle: { en: "Message sent!", es: "Mensaje recibido" },
    sentBody: {
      en: "Thanks for reaching out. I'll get back to you within 48 hours.",
      es: "Gracias por escribirme. Te responderé en las próximas 48 horas.",
    },
  },
    ...
    links: [
      {
        ...
        href: "mailto:luiseduardobaezlapaix@gmail.com",
      },
      {
        label: { en: "LinkedIn", es: "LinkedIn" },
        href: "https://linkedin.com",
